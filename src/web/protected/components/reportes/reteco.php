...
class reteco extends Reportes 
{
    ...
    {
        $styleRowsNumb="style='background:#83898F;color:white;border:1px solid white;text-align:center;'";
        $styleCarriers="style='background:silver;color:white;border:1px solid white;text-align:center;'";
        $styleActived="style='background:#F0950C;color:white;border:1px solid white;text-align:center;'";
        $styleContrato="style='background:#06ACFA;color:white;border:1px solid white;text-align:center;'";
        $styleTPCustom="style='background:#049C47;color:white;border:1px solid white;text-align:center;'";
        $styleTPSupplr="style='background:#F89289;color:white;border:1px solid white;text-align:center;'";
        $styleRowBasic="style='color:black;border:1px solid silver;text-align:left;'";
