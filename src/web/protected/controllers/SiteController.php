...
//                  $correos['recredi']['asunto']="SINE - RECREDI ".Reportes::defineNameExtra($_POST['id_termino_pago'],$this->trueFalse($_POST['type_termino_pago']),NULL)." ".self::reportTitle($date);
               ...
               case 'difference':
                    ...
                    $correos['difference']['cuerpo']=Yii::app()->reportes->billing($date,$this->trueFalse($_POST['Si_inter']),$this->trueFalse($_POST['Si_act']),$this->trueFalse($_POST['type_termino_pago']),$_POST['id_termino_pago']);
        ...
        if(isset($_GET['datepicker']))
        {
            ...
            switch ($_GET['tipo_report'])
            {
                ...
                case 'difference':
                    ...
                    $archivos['difference']['cuerpo']=Yii::app()->reportes->billing($date,$this->trueFalse($_GET['Si_inter']),$this->trueFalse($_GET['Si_act']),$this->trueFalse($_GET['type_termino_pago']),$_GET['id_termino_pago']);
                    break;
                case 'recopa':
