 ...
 * @property AccountingDocumentProvisions $idAccountingDocument
 * @property AccountingDocumentProvisions[] $accountingDocuments
 ...
 */
class AccountingDocumentProvisions extends CActiveRecord
{
    /**
     * Returns the static model of the specified AR class.
     * @param string $className active record class name.
     * @return AccountingDocumentProvisions the static model class
     */
    ...
    public function relations()
    {
        ...
        return array(
            'idAccountingDocument' => array(self::BELONGS_TO, 'AccountingDocumentProvisions', 'id_accounting_document'),
            'accountingDocuments' => array(self::HAS_MANY, 'AccountingDocumentProvisions', 'id_accounting_document'),
